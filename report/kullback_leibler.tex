...
The \emph{Kullback-Leibler} (KL) Divergence is not a mesure of a distance between subsets of the corpus, but is, as its name indicates it, a divergence between them. Indeed, let us consider sets $P$ and $Q$ containing articles for one year each. The KL divergence is defined as follows :
