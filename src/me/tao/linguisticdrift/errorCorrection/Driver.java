...
public class Driver {
	...
	public static void main(String[] args) throws Exception {	
	    ...
	    job_correct.setJarByClass(me.tao.linguisticdrift.errorcorrection.Driver.class);
	    ...
	    job_rank.setJarByClass(me.tao.linguisticdrift.errorcorrection.Driver.class);
