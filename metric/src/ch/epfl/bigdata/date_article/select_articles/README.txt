...
spark-submit --class "SelectArticle" --master yarn-cluster --executor-memory 8g --num-executors 50 target/scala-2.10/selectarticle_2.10-1.0.jar 1995 15 hdfs:///projects/linguistic-shift/corrected_nGramArticle/nGram/ hdfs:///user/your_username/
